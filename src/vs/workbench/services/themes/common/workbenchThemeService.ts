...
export namespace ThemeSettingDefaults {
	export const COLOR_THEME_DARK = isOSS ? 'DevForge Teal' : 'Default Dark Modern';
...
export const COLOR_THEME_DARK_INITIAL_COLORS = {
	'actionBar.toggledBackground': '#0F293E',
	'activityBar.activeBorder': '#FFCE00',
	'activityBar.background': '#091F2C',
	'activityBar.border': '#091F2C',
	'activityBar.foreground': '#D7D7D7',
	'activityBar.inactiveForeground': '#868686',
	'activityBarBadge.background': '#FFCE00',
	'activityBarBadge.foreground': '#FFFFFF',
	'badge.background': '#FFCE00',
	'badge.foreground': '#F8F8F8',
	'button.background': '#FFCE00',
	'button.border': '#091F2C',
	'button.foreground': '#FFFFFF',
	'button.hoverBackground': '#7E19FF',
	'button.secondaryBackground': '#0F293E',
	'button.secondaryForeground': '#CCCCCC',
	'button.secondaryHoverBackground': '#13334C',
	'chat.slashCommandBackground': '#FFCE0066',
	'chat.slashCommandForeground': '#7AA2F7',
	'chat.editedFileForeground': '#E2C08D',
	'checkbox.background': '#0F293E',
	'checkbox.border': '#091F2C',
	'debugToolBar.background': '#091F2C',
	'descriptionForeground': '#9D9D9D',
	'dropdown.background': '#0F293E',
	'dropdown.border': '#091F2C',
	'dropdown.foreground': '#CCCCCC',
	'dropdown.listBackground': '#0F293E',
	'editor.background': '#13334C',
	'editor.findMatchBackground': '#FFCE0080',
	'editor.foreground': '#CCCCCC',
	'editor.inactiveSelectionBackground': '#0F293E',
	'editor.selectionHighlightBackground': '#7AA2F726',
	'editorGroup.border': '#091F2C',
	'editorGroupHeader.tabsBackground': '#0F293E',
	'editorGroupHeader.tabsBorder': '#091F2C',
	'editorGutter.addedBackground': '#2EA043',
	'editorGutter.deletedBackground': '#F85149',
	'editorGutter.modifiedBackground': '#FFCE00',
	'editorIndentGuide.activeBackground1': '#707070',
	'editorIndentGuide.background1': '#404040',
	'editorLineNumber.activeForeground': '#CCCCCC',
	'editorLineNumber.foreground': '#6E7681',
	'editorOverviewRuler.border': '#091F2C',
	'editorWidget.background': '#0F293E',
	'errorForeground': '#F7768E',
	'focusBorder': '#7AA2F7',
	'foreground': '#CCCCCC',
	'icon.foreground': '#CCCCCC',
	'input.background': '#0F293E',
	'input.border': '#091F2C',
	'input.foreground': '#CCCCCC',
	'input.placeholderForeground': '#989898',
	'inputOption.activeBackground': '#FFCE0082',
	'inputOption.activeBorder': '#FFCE00',
	'keybindingLabel.foreground': '#CCCCCC',
	'list.activeSelectionIconForeground': '#FFF',
	'list.dropBackground': '#0F293E',
	'menu.background': '#0F293E',
	'menu.border': '#091F2C',
	'menu.foreground': '#CCCCCC',
	'menu.selectionBackground': '#FFCE00',
	'menu.separatorBackground': '#091F2C',
	'notificationCenterHeader.background': '#0F293E',
	'notificationCenterHeader.foreground': '#CCCCCC',
	'notifications.background': '#0F293E',
	'notifications.border': '#091F2C',
	'notifications.foreground': '#CCCCCC',
	'panel.background': '#0F293E',
	'panel.border': '#091F2C',
	'panelInput.border': '#091F2C',
	'panelTitle.activeBorder': '#FFCE00',
	'panelTitle.activeForeground': '#CCCCCC',
	'panelTitle.inactiveForeground': '#9D9D9D',
	'peekViewEditor.background': '#13334C',
	'peekViewEditor.matchHighlightBackground': '#7AA2F766',
	'peekViewResult.background': '#0F293E',
	'peekViewResult.matchHighlightBackground': '#7AA2F766',
	'pickerGroup.border': '#091F2C',
	'ports.iconRunningProcessForeground': '#369432',
	'progressBar.background': '#FFCE00',
	'quickInput.background': '#0F293E',
	'quickInput.foreground': '#CCCCCC',
	'settings.dropdownBackground': '#0F293E',
	'settings.dropdownBorder': '#091F2C',
	'settings.headerForeground': '#FFFFFF',
	'settings.modifiedItemIndicator': '#FFCE0066',
	'sideBar.background': '#0F293E',
	'sideBar.border': '#091F2C',
	'sideBar.foreground': '#CCCCCC',
	'sideBarSectionHeader.background': '#0F293E',
	'sideBarSectionHeader.border': '#091F2C',
	'sideBarSectionHeader.foreground': '#CCCCCC',
	'sideBarTitle.foreground': '#CCCCCC',
	'statusBar.background': '#091F2C',
	'statusBar.border': '#091F2C',
	'statusBar.debuggingBackground': '#7AA2F7',
	'statusBar.debuggingForeground': '#13334C',
	'statusBar.focusBorder': '#FFCE00',
	'statusBar.foreground': '#CCCCCC',
	'statusBar.noFolderBackground': '#091F2C',
	'statusBarItem.focusBorder': '#FFCE00',
	'statusBarItem.prominentBackground': '#F7768E',
	'statusBarItem.remoteBackground': '#FFCE00',
	'statusBarItem.remoteForeground': '#FFFFFF',
	'tab.activeBackground': '#13334C',
	'tab.activeBorder': '#13334C',
	'tab.activeBorderTop': '#FFCE00',
	'tab.activeForeground': '#FFFFFF',
	'tab.border': '#091F2C',
	'tab.hoverBackground': '#13334C',
	'tab.inactiveBackground': '#0F293E',
	'tab.inactiveForeground': '#9D9D9D',
	'tab.lastPinnedBorder': '#091F2C',
	'tab.selectedBackground': '#0F293E',
	'tab.selectedBorderTop': '#FFCE00',
	'tab.selectedForeground': '#ffffffa0',
	'tab.unfocusedActiveBorder': '#13334C',
	'tab.unfocusedActiveBorderTop': '#091F2C',
	'tab.unfocusedHoverBackground': '#13334C',
	'terminal.foreground': '#CCCCCC',
	'terminal.inactiveSelectionBackground': '#0F293E',
	'terminal.tab.activeBorder': '#FFCE00',
	'textBlockQuote.background': '#0F293E',
	'textBlockQuote.border': '#FFCE00',
	'textCodeBlock.background': '#0F293E',
	'textLink.activeForeground': '#7AA2F7',
	'textLink.foreground': '#7AA2F7',
	'textPreformat.background': '#0F293E',
	'textPreformat.foreground': '#D0D0D0',
	'textSeparator.foreground': '#091F2C',
	'titleBar.activeBackground': '#091F2C',
	'titleBar.activeForeground': '#CCCCCC',
	'titleBar.border': '#091F2C',
	'titleBar.inactiveBackground': '#091F2C',
	'titleBar.inactiveForeground': '#9D9D9D',
	'welcomePage.progress.foreground': '#FFCE00',
	'welcomePage.tileBackground': '#0F293E',
	'widget.border': '#091F2C'
};
